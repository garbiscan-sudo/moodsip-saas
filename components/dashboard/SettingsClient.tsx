      ...
      <section className="glass rounded-2xl p-6">
        ...
        {isActive ? (
          ...
          <>
            ...
            {!payStep ? (
              <>
                <div className="glass rounded-xl p-5 border border-gold/30 bg-gold/5 mb-5">
                  <div className="font-semibold mb-1">Yıllık Plan</div>
                  <div className="font-serif text-3xl text-gold mb-1">₺{PRICE_YEARLY}</div>
                  <div className="text-white/40 text-xs">KDV dahil / yıl</div>
                </div>
              ...
              <form onSubmit={handlePayment} className="space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button type="submit" disabled={payLoading} className="btn-gold flex-1 py-2.5 text-sm flex items-center justify-center gap-2">
                    <Shield size={14} />
                    {payLoading ? 'İşleniyor...' : `₺${PRICE_YEARLY} Öde`}
                  </button>
                </div>
              </form>
            )}
